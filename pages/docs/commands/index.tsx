...
const CommandsPage: FC<{
	...
	return (
		<DocsLayout>
			<Section>Getting Started with Commands</Section>
			<p>
				Click on any of the commands to view a list that includes all
				possible options.
			</p>
			<p>
				Our handy search bar provides more information about each
				command including how-tos/guides related specifically towards
				different tasks within our system. Please contact us if you need
				help understanding something
			</p>
			<Section className="my-4">Command List</Section>
			<div>
			...
			<div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
				{orderBy(
					...
					return (
						...
						>
							<div className="relative rounded-lg border cursor-pointer bg-gray-100 px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-green-500">
