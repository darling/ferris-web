		...
		<Layout>
			<div className="md:w-2/4 mx-auto my-16 text-gray-100">
				...
				<p>
					...
					https://ferrisbot.app/, you are agreeing to be bound by
				...
				<p className="mb-4">
					...
					the materials on ferrisbot.app's Website for personal,
				...
				<p className="mb-4">
					This will let ferrisbot.app to terminate upon violations of
				...
				<p>
					All the materials on ferrisbot.app’s Website are provided
					"as is". ferrisbot.app makes no warranties, may it be
					expressed or implied, therefore negates all other
					warranties. Furthermore, ferrisbot.app does not make any
				...
				<p>
					ferrisbot.app or its suppliers will not be hold accountable
					for any damages that will arise with the use or inability to
					use the materials on ferrisbot.app’s Website, even if
					ferrisbot.app or an authorize representative of this Website
				...
				<p>
					The materials appearing on ferrisbot.app’s Website may
					include technical, typographical, or photographic errors.
					ferrisbot.app will not promise that any of the materials in
					this Website are accurate, complete, or current.
					ferrisbot.app may change the materials contained on its
					Website at any time without notice. ferrisbot.app does not
				...
				<p>
					ferrisbot.app may revise these Terms of Use for its Website
				...
				<p>
					Any claim related to ferrisbot.app's Website shall be
					governed by the laws of us without regards to its conflict
					of law provisions.
				</p>
			</div>
		</Layout>
