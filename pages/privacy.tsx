	...
	return (
		<Layout>
			<div className="md:w-2/4 mx-auto my-16 text-gray-100">
				...
				<h2 className="text-lg mb-3">Information we collect</h2>
				...
				<p className="mb-3">
					...
					contact information, including items such as name and email.
				</p>

				<h2 className="text-lg mb-3">How we use your information</h2>
				...
				<h2 className="text-lg mb-3">GDPR Data Protection Rights</h2>
				...
				<h2 className="text-lg mb-3">Children's Information</h2>
