...
export const HomeHero = () => {
  return (
    <div className="relative flex flex-col-reverse px-4 py-16 mx-auto lg:block lg:flex-col lg:py-32 xl:py-48 md:px-8 sm:max-w-xl md:max-w-full">
      <div className="hidden lg:contents z-0 flex justify-center h-full overflow-hidden lg:pt-24 lg:pb-16 lg:pr-8 xl:pr-0 lg:w-1/2 lg:absolute lg:justify-end lg:bottom-0 lg:left-0 lg:items-center">
        <img
          src="https://i.imgur.com/mEbkkA2.png"
          className="object-right w-full h-auto lg:w-auto lg:h-full"
          alt=""
        />
      </div>
        ...
        <div className="mb-16 lg:pr-5 lg:max-w-lg lg:mb-0">
          <div className="max-w-xl mb-6">
            <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold text-gray-100 sm:text-4xl sm:leading-none">
              Let Ferris protect your <br className="hidden md:block" />{" "}
              <span className="inline-block text-green-400">community</span>.
            </h2>
            <p className="text-base text-green-100 md:text-lg">
              Ferris is a discord bot created to secure and manage Discord
      ...
      <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
        <div className="flex flex-col mb-16 sm:text-center sm:mb-0">
          ...
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            ...
            <p className="text-base text-green-100 md:text-lg">
              Try Ferris for free, if you don't like it, don't use it! Ferris is
              under development, so please make sure to check out the Support
              Server to input constructive critisizm or suggest new features.
            </p>
          </div>
          <div>
            <Link href="/">
