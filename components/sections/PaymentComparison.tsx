					...
					<div className="max-w-2xl mx-auto lg:hidden">
						<div className="px-4 ">
							...
							<p className="mt-4 text-sm text-gray-500">
								Anyone can test out the basics of Ferris with
								this tier.
							</p>
						</div>
								...
								<tr className="border-t border-gray-200">
									...
									<td className="py-5 pr-4">
										<svg
											...
											data-todo-x-description="Heroicon name: solid/minus"
											xmlns="http://www.w3.org/2000/svg"
											viewBox="0 0 20 20"
											fill="currentColor"
											aria-hidden="true"
							...
							<tbody className="divide-y divide-gray-200">
								...
								<tr className="border-t border-gray-200">
									<th
										...
										scope="row"
									>
										Elementum ut dapibus mi feugiat cras
										nisl.
									</th>
									<td className="py-5 pr-4">
										<svg
							...
							<tbody className="divide-y divide-gray-200">
								...
								<tr className="border-t border-gray-200">
									<th
										...
										scope="row"
									>
										Tristique pellentesque ornare diam
										sapien.
									</th>
									<td className="py-5 pr-4">
										<svg
						...
						<div className="px-4 mt-16">
							...
							<p className="mt-4 text-sm text-gray-500">
								Quis eleifend a tincidunt pellentesque. A tempor
								in sed.
							</p>
							<a
								href="/"
						...
						<div className="px-4 mt-16">
							...
							<p className="mt-4 text-sm text-gray-500">
								Orci volutpat ut sed sed neque, dui eget. Quis
								tristique non.
							</p>
							<a
								href="/"
								...
								<tr>
									...
									<td className="h-full py-8 px-6 align-top">
										<div className="relative h-full table">
											...
											<p className="mt-4 mb-16 text-sm text-gray-500">
												Quis suspendisse ut fermentum
												neque vivamus non tellus.
											</p>
											<a
												href="/"
									...
									<td className="h-full py-8 px-6 align-top">
										<div className="relative h-full table">
											...
											<p className="mt-4 mb-16 text-sm text-gray-500">
												Quis eleifend a tincidunt
												pellentesque. A tempor in sed.
											</p>
											<a
												href="/"
												className="absolute bottom-0 flex-grow block w-full bg-gray-800 border border-gray-800 rounded-md 5 py-2 text-sm font-semibold text-white text-center hover:bg-gray-900"
									...
									<td className="h-full py-8 px-6 align-top">
										<div className="relative h-full table">
											...
											<p className="mt-4 mb-16 text-sm text-gray-500">
												Orci volutpat ut sed sed neque,
												dui eget. Quis tristique non.
											</p>
											<a
												href="/"
												className="absolute bottom-0 flex-grow block w-full bg-gray-800 border border-gray-800 rounded-md 5 py-2 text-sm font-semibold text-white text-center hover:bg-gray-900"
